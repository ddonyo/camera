            ...
            try {
                ...
                if (code !== 0) {
                    ...
                    if (stderr.includes('ModuleNotFoundError') || stderr.includes('ImportError')) {
                        errorMessage = 'Missing Python dependencies. Please run: pip install rembg[new] onnxruntime aiohttp filetype pillow numpy';
                    }
                ...
                if (!fs.existsSync(outputPath)) {
                    ...
                    return res.status(500).json({ error: 'Background removal failed - no output file' });
                }
